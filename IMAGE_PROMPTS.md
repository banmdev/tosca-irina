...
as `01-hero.png` … `12-signoff.png`.

## Target specs

- **Aspect ratio:** 9:16 vertical (1080×1920 or similar)
- **Format:** PNG (Nano Banana 2 default output)
...
### 04 — Characters · `04-characters.png`
...
### 06 — Recondita armonia · `06-recondita.png`
...
### 10 — E lucevan le stelle · `10-lucevan.png`
